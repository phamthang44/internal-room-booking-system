...
This project is indexed by GitNexus as **room-booking** (3415 symbols, 9505 relationships, 268 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
